> **⚠️ OBSOLETE (2026-02-16):** Core UI/UX findings resolved:
> - Focus indicator contrast: TCK-20260213-061, system focus ring color
> - Escape closes search: TCK-20260213-063, `onExitCommand` handler
> - Session terminology: TCK-20260213-069, unified "End Session"
> - Reveal in Finder: TCK-20260213-066, `NSWorkspace.shared.activateFileViewerSelecting`
> - Onboarding step labels: TCK-20260213-071, "Step X of Y" (`OnboardingView.swift:21`)
> Remaining items are minor copywriting/clarity polish. Moved to archive.
