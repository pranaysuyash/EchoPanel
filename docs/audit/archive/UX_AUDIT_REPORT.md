> **⚠️ OBSOLETE (2026-02-16):** Core UX findings addressed:
> - Audio level indicators: dual source meters in SidePanelView
> - Global hotkey: `HotKeyManager.swift` with 10+ hotkey functions (start/stop, toggle panel, etc.)
> - Onboarding flow: step labels, permission explanations (`OnboardingView.swift`)
> - Session history: `SessionHistoryView.swift` with search, Reveal in Finder
> Remaining items are minor polish. Moved to archive.
