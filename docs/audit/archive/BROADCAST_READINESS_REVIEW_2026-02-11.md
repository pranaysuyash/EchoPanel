> **📁 ARCHIVED (2026-02-16):** EchoPanel is a meeting transcription tool, not a broadcast captioning system.
> This review scored the app against broadcast standards (NTP sync, SRT/VTT, burn-in, UDP/RTP) which are out of scope.
> The review's own conclusion: "fundamentally unsuitable for live broadcast captioning without substantial architectural changes."
> Correct assessment — broadcast is not a target. Moved to archive.
