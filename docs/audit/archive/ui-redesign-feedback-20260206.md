> **📁 ARCHIVED (2026-02-16):** Early UI feedback from Feb 6, largely superseded by subsequent UI work.
> Multiple UI improvements shipped since: focus indicator contrast (TCK-20260213-061), escape closes search
> (TCK-20260213-063), unified terminology (TCK-20260213-069), Reveal in Finder (TCK-20260213-066),
> step indicators in onboarding (TCK-20260213-071), `DesignTokens.swift` created.
> Remaining visual polish items tracked in current UI audits. Moved to archive.
