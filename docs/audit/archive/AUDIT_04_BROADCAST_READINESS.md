> **📁 ARCHIVED (2026-02-16):** Broadcast captioning readiness is out of scope for EchoPanel v0.2.
> Core meeting transcription features work. Broadcast-specific items (NTP, EBU-TT, hot-keys, live PII redaction)
> are not in the product roadmap. Moved to archive.
