...
- Generated: 2026-05-25T05:03:06Z
- Project: `EchoPanel`
- Provider: `local`
- Model: `BAAI/bge-m3`
- Project collection: `projects_proj_echopanel`
- Shared collection: `projects_workspace_shared`

## Project Motto

- File: `/Users/pranay/Projects/EchoPanel/motto_v2.md`
...
- Collection: `projects_proj_echopanel`
- Query: `architecture decisions for EchoPanel`
_Fast mode (--skip-index): retrieval skipped to keep startup non-blocking. Run `/Users/pranay/Projects/agent-start --project EchoPanel` for full retrieval, or set `AGENT_START_SKIP_INDEX_RETRIEVE=1` if you want retrieval with skip-index._

### Project Management Workflow
- Collection: `projects_proj_echopanel`
- Query: `project management workflow for EchoPanel`
_Fast mode (--skip-index): retrieval skipped to keep startup non-blocking. Run `/Users/pranay/Projects/agent-start --project EchoPanel` for full retrieval, or set `AGENT_START_SKIP_INDEX_RETRIEVE=1` if you want retrieval with skip-index._

### Known Issues and Worklogs
- Collection: `projects_proj_echopanel`
- Query: `known issues and worklog for EchoPanel`
_Fast mode (--skip-index): retrieval skipped to keep startup non-blocking. Run `/Users/pranay/Projects/agent-start --project EchoPanel` for full retrieval, or set `AGENT_START_SKIP_INDEX_RETRIEVE=1` if you want retrieval with skip-index._

### Prompts and Guidelines
- Collection: `projects_proj_echopanel`
- Query: `prompts and guidelines for EchoPanel`
_Fast mode (--skip-index): retrieval skipped to keep startup non-blocking. Run `/Users/pranay/Projects/agent-start --project EchoPanel` for full retrieval, or set `AGENT_START_SKIP_INDEX_RETRIEVE=1` if you want retrieval with skip-index._

### System Learning Graph
- Collection: `projects_proj_echopanel`
- Query: `knowledge graph memory learning feedback loops autoresearch semantic taste graph for EchoPanel`
_Fast mode (--skip-index): retrieval skipped to keep startup non-blocking. Run `/Users/pranay/Projects/agent-start --project EchoPanel` for full retrieval, or set `AGENT_START_SKIP_INDEX_RETRIEVE=1` if you want retrieval with skip-index._
...
- Query: `similar architecture patterns for EchoPanel`
_Fast mode (--skip-index): retrieval skipped to keep startup non-blocking. Run `/Users/pranay/Projects/agent-start --project EchoPanel` for full retrieval, or set `AGENT_START_SKIP_INDEX_RETRIEVE=1` if you want retrieval with skip-index._
