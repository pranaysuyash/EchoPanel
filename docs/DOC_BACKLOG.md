...
| DOC-002A | `docs/STATUS_AND_ROADMAP.md` → “Pre-Launch Checklist” | qa | Test Native MLX backend offline capability. | "Test Native MLX backend works without internet" | qa | Low / runtime behavior | S | None | new |
| DOC-002B | `docs/STATUS_AND_ROADMAP.md` → “Pre-Launch Checklist” | qa | Test Cloud backend failure handling. | "Test Cloud backend graceful failure and reconnection" | qa | Med / runtime behavior | S | None | new |
| DOC-002C | `docs/STATUS_AND_ROADMAP.md` → “Pre-Launch Checklist” | qa | Verify error messages are user-friendly. | "Verify connection error messages are clear" | qa | Low / UX | S | None | new |
...
| DOC-008 | `docs/PROJECT_MANAGEMENT.md` → “Open TODOs” | improvement | Add integration tests for WebSocket streaming and exports. | “Add integration tests for WebSocket streaming and exports.” | tests | Med / regressions | M | None | done |
