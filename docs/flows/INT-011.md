...
- 1–2 sentence description: Extracts entities and action/decision/risk cards from transcript segments, attaching grounding quotes and evidence pointers to source transcript for verifiability.
