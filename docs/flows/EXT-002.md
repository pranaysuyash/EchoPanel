...
- Test gaps to add (note only, no implementation): Test permission revocation during active session, test permission grant without restart</content>
  <parameter name="filePath">/Users/pranay/Projects/EchoPanel/docs/flows/EXT-002.md
