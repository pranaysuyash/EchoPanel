...
- Test gaps to add (note only, no implementation): Test ping failure triggers reconnection</content>
  <parameter name="filePath">/Users/pranay/Projects/EchoPanel/docs/flows/NET-008.md
