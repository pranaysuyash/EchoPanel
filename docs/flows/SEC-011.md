...
- Origin: Code-only
- Status: Implemented
- 1–2 sentence description: Applies privacy controls during session bundle creation and export, excluding sensitive data like audio by default and hashing identifiers.
