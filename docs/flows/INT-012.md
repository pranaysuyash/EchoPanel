...
- Origin: Doc-only
- Status: Hypothesized
- 1–2 sentence description: Runs high-accuracy NER and analysis on complete session transcript after session ends, using transformer models for better precision than real-time analysis.
