...
- Origin: Code-only
- Status: Partial
- 1–2 sentence description: Detects USB audio device disconnection during active sessions and attempts automatic recovery by restarting audio capture with minimal interruption.
