...
- Origin: Code-only
- Status: Implemented
- 1–2 sentence description: Automatically restarts the Python backend server after unexpected crashes using exponential backoff with a maximum of 3 attempts, preventing permanent service loss.
