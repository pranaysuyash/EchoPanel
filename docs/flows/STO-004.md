...
- Test gaps to add (note only, no implementation): Test marker persistence across app restarts</content>
  <parameter name="filePath">/Users/pranay/Projects/EchoPanel/docs/flows/STO-004.md
